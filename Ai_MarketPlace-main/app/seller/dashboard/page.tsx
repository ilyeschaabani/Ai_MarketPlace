        ...
        <div className="mb-8">
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="flex gap-3">
              ...
              <Link href="/fraud_detection/annonces/create">
        ...
        <Card className="bg-primary/5 border-primary/20">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-lg">
              ...
              Intelligence Artificielle - Protection Anti-Fraude
            </CardTitle>
            <CardDescription>
              ...
              <br />
              ✅ Vos annonces légitimes bénéficient d'un badge de confiance vérifié par IA.
            </CardDescription>
          </CardHeader>
        </Card>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 p-3 border rounded-lg">
                ...
                <div className="flex-1">
                  <p className="font-medium">Performance en hausse</p>
                  <p className="text-sm text-muted-foreground">+23% de vues cette semaine</p>
                </div>
